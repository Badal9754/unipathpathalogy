                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="gallery"><img src="<?= base_url() ?>upload/service/<?= $image ?>" height="100" /></div>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                         
                                        <div class="row">
                                            <label for="example-text-input" class="col-md-12 col-form-label">Service Image</label>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="row">
                                            <label for="example-text-input" class="col-md-12 col-form-label">Service Title</label>
                                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="row">
                                            <label for="example-text-input" class="col-md-12 col-form-label">Service Content</label>
                                            <div class="col-md-12">
