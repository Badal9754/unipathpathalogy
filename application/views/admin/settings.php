                                                ...
                                                <td>
                                                    <form action="" method="post" class="row" enctype="multipart/form-data">
                                                        <div class="form-group col-10">
                                                            ...
                                                            ?>
                                                                <input type="text" class="form-control" placeholder="Enter value" value="<?= $all['content_value'] ?>" name="record_value">
                                                            <?php
                                                            } elseif ($all['value_type'] == 'option') {
                                                            ?>
                                                                <select name="record_value" class="form-control">
                                                                    <option value="0" <?= ($all['content_value'] == '0') ? 'selected' : '' ?>>Yes</option>
                                                                    <option value="1" <?= ($all['content_value'] == '1') ? 'selected' : '' ?>>No</option>
                                                                </select>
                                                            <?php
                                                            } elseif ($all['value_type'] == 'date') {
                                                            ?>
                                                                <input type="date" class="form-control" placeholder="Enter value" value="<?= $all['content_value'] ?>" name="record_value">

                                                            <?php
                                                            } elseif ($all['value_type'] == 'large_text') {
                                                            ?>
                                                                <textarea name="record_value"  class="editor" ><?= $all['content_value'] ?></textarea>
                                                            <?php
                                                            } else {
                                                            ?>
                                                                <input type="file" class="form-control" placeholder="Enter value" value="<?= $all['content_value'] ?>" name="record_value">
                                                                <?php

                                                                if ($all['content_value'] != '') {
                                                                ?>
                                                                    <img src="<?= base_url($all['content_value']) ?>" style="width:100px;" />
                                                                <?php
                                                                }
                                                                ?>
                                                            <?php
